<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 shadow-sm bg-blue">
  <div class="col-md-3 mb-2 mb-md-0">
    <ul class="nav col-12 col-md-auto mb-2 mb-md-0">
      ...
      <li><p class="usernameNav text-yellow col ml-md-1 mb-0 "><?php if (isset($_SESSION["Username"])) { echo  $_SESSION["Username"];}?></p></li>
    </ul>
  </div>
  ...
  <?php if (isset($_SESSION["Status"])) { ?>
    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
      ...
      <li><a href="#" class="nav-link text-body" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" data-target="#"><i class="bi bi-search h4"></i></a></li>
