<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 shadow-sm bg-blue">
  ...
  <?php if (isset($_SESSION["Email"])) { ?>
    ...
    <div class="col-md-3 text-end">
      <a href="backend/logout.php"><button type="button" class="btn btn-primary btn-round mr-1">Logout</button></a>
    </div>
  ...
  <?php } else { ?>
    ...
    <div class="col-md-3 text-end">
      <a href="index.php?op=loginPage"><button type="button" class="btn btn-primary btn-round mr-1">Login</button></a>
    </div>
    ...
    <div class="col-md-3 text-end">
      <a href="index.php?op=registerPage"><button type="button" class="btn btn-primary btn-round mr-1">Register</button></a>
    </div>
